<section id="mainarea">
    <div class="maincontent">
        ...
        <div class="headline">
            <div class="headline-title">
                <h1>Classement : {PHASE_NAME}</h1>
                <span>Après {NB_GAMES_PLAYED} matchs joués sur {NB_GAMES_TOTAL}</span>
            </div>
            <div class="headline-menu">
                <a href="/?op=view_ranking_phase"><strong>{GENERAL_CUP_LABEL}</strong></a>
        ...
        <table class="ranking">
            <tr>
                ...
                <th width="13%">Résultats Exacts</th>
                <th width="12%">Perfects</th>
    ...
    <script type="text/javascript">
        function changePhase(phaseID) {
            window.location.assign('?op=view_ranking_phase&phase=' + phaseID);
        }
        getTags();
    </script>
</section>
