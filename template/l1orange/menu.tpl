<nav>
  <!-- BEGIN user_bar -->
	<ul class="nav-group">
		<li class="nav-group-item"><a href="/?op=view_ranking">Classement Général</a></li>
		<li class="nav-group-item"><a href="/?op=view_ranking_phase">Classement Journée</a></li>
  ...
  <!-- BEGIN admin_bar -->
	<ul class="nav-group admin">
		<li class="nav-group-item"><a href="/?op=edit_instances">Instances</a></li>
