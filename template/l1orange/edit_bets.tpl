    ...
    <div class="tag_cloud">
  	...
  	<td width="5%" align="left" style="white-space:nowrap;font-size:7pt;" rowspan="2">{bets.IMG}</td>
        ...
        <td width="12%" style="text-align:right;">
          <input type="number" min="0" max="99" size="2" name="iptScoreTeam_A_{bets.MATCH_ID}" id="iptScoreTeam_A_{bets.MATCH_ID}" value="{bets.SCORE_BET_A}" {bets.DISABLED} />
        </td>
  	<td width="7%" style="text-align:center; font-weight:300; font-size:9px; color:{bets.COLOR};" rowspan="2">
        ...
        <td width="12%" style="text-align:left;">
          <input type="number" min="0" max="99" size="2" name="iptScoreTeam_B_{bets.MATCH_ID}" id="iptScoreTeam_B_{bets.MATCH_ID}" value="{bets.SCORE_BET_B}" {bets.DISABLED} />
        </td>
